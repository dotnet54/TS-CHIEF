 ...
 *
 */
public class AppRunConfigurations {
...
//			"-rif_transform_level=node", //only node is implemented
	...
	public static final String[] sat_args = new String[]{
			"-train=E:\\data\\SatelliteFull\\sk_stratified\\SatelliteFull_TRAIN_c26050.arff",
			"-test=E:\\data\\SatelliteFull\\sk_stratified\\SatelliteFull_TEST_1000.arff",
			"-target_column=last",
			"-csv_has_header=true",
			"-repeats=1",
	...
	public static final String[] sat_args2 = new String[]{
			"-train=E:\\data\\SatelliteFull\\sk_stratified\\SatelliteFull_TRAIN_c"+sampleSize+".arff",
			"-test=E:\\data\\SatelliteFull\\sk_stratified\\SatelliteFull_TEST_1000.arff",
			"-target_column=last",
			"-csv_has_header=true",
			"-repeats=1",
