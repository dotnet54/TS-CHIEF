...
public class TreeStatCollector {
	...
	protected transient TSCheifTree tree;
	...
	//tree stats
	public Date train_start_timestamp;
...
//	"euc_time, dtw_time, dtwr_time, ddtw_time, ddtwr_time, wdtw_time, wddtw_time, lcss_time, twe_time,erp_time,msm_time,"+
	...
	//memory usage
	public long before_train_mem_use;
	public long after_train_mem_use;
	public long after_test_mem_use;
	
	protected boolean results_aggregated = false;

	public TreeStatCollector(TSCheifTree tree){		
		this.tree = tree;
	}
